...
function NewUser(){
    ...
    return(
        ...
        <Heading><Text fontFamily='ClashDisplay-Bold'>GetStarted</Text></Heading>
        <Text color='GrayText'>
        continue buying and selling household items easily </Text>
        <Link to="/sign-up">
        <Button>Sign Up with Email</Button> </Link>
        ...
        <Link to='/sign-in'><span style={{color: '#E66F15', fontWeight:'400px'}}>Log In</span> </Link> 
