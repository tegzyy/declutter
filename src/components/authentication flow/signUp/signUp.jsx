...
function SignUp(){
   ...
   name="email" value={email}/>
       ...
       Terms & Conditions and Privacy Policy</span></Text> </Box>

       <Button buttonType='inverted'>Sign Up</Button>

       <Text color='gray' fontSize='12px' w='250px' display='flex' 
       textAlign='center' justifyContent='center' pl='15px' mt='10px'
       >Already a registered user? 
       <Link to="/sign-in">
       <span style={{color: '#E66F15', marginLeft: '5px'}}>
       Log In</span> </Link></Text>
